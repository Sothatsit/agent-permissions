...
assert_contains "prompts off: reason says how to restore prompts" \
    "$(_reason "$out")" "agent-permissions prompts on"
assert_contains "prompts off: reason warns against flipping the switch" \
    "$(_reason "$out")" "leave them on"
